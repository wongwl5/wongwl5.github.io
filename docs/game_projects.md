...
- Implemented the unique shared mana pool system
- Spearheaded the development of the spell-casting system to display spell ranges, area-of-effect range and activation of the spell
- Aided fellow team members in debugging issues with other various systems in the game
...
![Battle City 3D Remake Screenshot](/assets/battlecity_image.png)
